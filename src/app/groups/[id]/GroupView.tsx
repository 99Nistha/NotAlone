      ...
      .on(
        ...
        (payload) => {
          ...
          setMessages((prev) => {
            ...
            return [...prev, { ...newMsg, profiles: { id: newMsg.user_id, full_name: newMsg.user_id === userId ? userFullName : "Member", location: null, created_at: "", updated_at: "" } }];
          });
        }
      )
      .subscribe();
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-gray-400">{group.member_count} members</div>
            </div>
          </div>
      ...
      {tab === "chat" && (
        <div className="flex-1 flex flex-col max-w-3xl mx-auto w-full px-4">
          {/* Messages */}
          <div className="flex-1 py-4 space-y-3 overflow-y-auto min-h-0">
            {messages.length === 0 && (
              ...
              return (
                ...
                >
                  <div className="text-xs text-gray-400 mb-1 px-1">
                    {isOwn ? "You" : (msg.profiles as { full_name?: string })?.full_name || "Member"} · {formatTime(msg.created_at)}
                  </div>
                  <div
          ...
          {/* Input */}
          <div className="border-t border-gray-100 bg-white py-3 sticky bottom-0">
